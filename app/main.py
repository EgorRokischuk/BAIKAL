...
from api.v1 import users, satellite_data_files, ground_data_files, chlorofill_files
...
app.include_router(chlorofill_files.chlorofill_data_router,
                   prefix="/api/v1/files/ground_data", tags=["Chlorofill data"])
